...
model.fit(x_train, y_train, epochs=300, batch_size=4096, verbose=2,
    validation_split=0.0005, callbacks=[es, tb])
...
time =  239.427973985672
loss[category] :  0.06727082282304764
loss[accuracy] :  0.9901000261306763
'''