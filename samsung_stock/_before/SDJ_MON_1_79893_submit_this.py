...
from tensorflow.keras.layers import Dense, SimpleRNN, Dropout, Input, LSTM, GlobalAveragePooling1D, Conv1D, Flatten
'''
# 2-1. model1
input1 = Input(shape=(40,4))
xx = LSTM(units=32, activation='relu', return_sequences=True)(input1)
# xx = LSTM(units=32, activation='relu')(xx)
output1 = Dense(32)(xx)

# 2-2. model2
input2 = Input(shape=(40,5))
xx = LSTM(units=32, activation='relu', return_sequences=True)(input2)
# xx = LSTM(units=32, activation='relu')(xx)
output2 = Dense(32)(xx)
...
xx = LSTM(units=16, activation='relu')(merge1)
...
'''
print('=================2. load model=================')
model = load_model('./_save/MCP_M/SDJ_02_0723_1215_0384_5799025.500000.hdf5')
