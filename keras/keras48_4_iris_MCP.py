...
#                      filepath='./_save/ModelCheckPoint/keras48_iris_MCP.hdf5')
...
# model.save('./_save/ModelCheckPoint/keras48_iris_model_save.h5')
model = load_model('./_save/ModelCheckPoint/keras48_iris_model_save.h5')
# model = load_model('./_save/ModelCheckPoint/keras48_iris_MCP.hdf5')
...
LSTM
time :  7.21506929397583
loss :  0.16448774933815002
acc :  0.9473684430122375

MCP CNN Conv1D
loss :  0.0713118314743042
acc :  0.9736841917037964

model save Conv1D
loss :  0.12253963202238083
acc :  0.9473684430122375
'''