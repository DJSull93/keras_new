...
# 1. data
sam = pd.read_csv('./02_samsung_stock/_data/samsung20210721.csv', encoding='EUC-KR')
sk = pd.read_csv('./02_samsung_stock/_data/SK20210721.csv', encoding='EUC-KR')
...
model.fit([xs_train, xk_train], y_train, epochs=10000, batch_size=128, verbose=1, 
