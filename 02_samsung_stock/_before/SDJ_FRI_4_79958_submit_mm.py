...
xx = GRU(units=10, activation='relu')(input1)
output1 = Dense(100)(xx)

# 2-2. model2
input2 = Input(shape=(20,5))
xx = GRU(units=10, activation='relu')(input2)
output2 = Dense(64)(xx)
...
merge2 = Dense(32, activation='relu')(merge1)
...
model.fit([xs_train, xk_train], y_train, epochs=1000, batch_size=1024, verbose=1, 
...
'''
print('=================2. load model=================')
model = load_model('./_save/MCP/SDJ_S01_0722_1811_0353_2574618.750000.hdf5')
