...
xx = Dense(270, activation='relu')(xx)
xx = Dense(240, activation='relu')(xx)
xx = Dropout(0.01)(xx)
xx = Dense(110, activation='relu')(xx)
xx = Dense(80, activation='relu')(xx)
output1 = Dense(16)(xx)
...
model.fit([xs_train, xk_train], y_train, epochs=10000, batch_size=2048, verbose=1, 
            callbacks=[es, mcp], validation_split=0.02)
