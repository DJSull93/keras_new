...
xx = LSTM(units=10, activation='relu')(input2)
output2 = Dense(100)(xx)
...
merge3 = Dense(32, activation='relu')(merge2)
...
'''
print('=================2. load model=================')
model = load_model('./_save/MCP/SDJ_S01_0722_1753_0119_10269470.000000.hdf5')
