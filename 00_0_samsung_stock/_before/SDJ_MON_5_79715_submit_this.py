...
# output1 = Dense(32)(xx)
output1 = LSTM(units=64, activation='relu')(input1)

# 2-2. model2
input2 = Input(shape=(40,5))
# xx = LSTM(units=32, activation='relu')(input2)
# output2 = Dense(32)(xx)
output2 = LSTM(units=64, activation='relu')(input2)
...
'''
print('=================2. load model=================')
model = load_model('./_save/MCP_M/SDJ_02_0723_1441_0181_5662490.500000.hdf5')
