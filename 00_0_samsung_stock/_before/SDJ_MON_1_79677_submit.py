...
xx = LSTM(units=256, activation='relu')(input1)
output1 = Dense(32)(xx)

# 2-2. model2
input2 = Input(shape=(20,5))
xx = LSTM(units=256, activation='relu')(input2)
output2 = Dense(32)(xx)
...
'''
print('=================2. load model=================')
model = load_model('./_save/MCP_M/SDJ_02_0723_1050_0103_26520320.000000.hdf5')
