...
xx = LSTM(units=2, activation='relu')(input1)
...
xx = LSTM(units=2, activation='relu')(input2)
xx = Dense(64, activation='relu')(xx)
xx = Dense(64, activation='relu')(xx)
output2 = Dense(16)(xx)
...
'''
print('=================2. load model=================')
model = load_model('./_save/MCP_M/SDJ_02_0723_1752_3665_857182.937500.hdf5')
